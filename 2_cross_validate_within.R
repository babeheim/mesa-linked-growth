...
out <- mclapply(1:n_cv_sets, function(validation_set) {
  ...
  print(paste("finished within-patient cross-validation set", validation_set))
...
png("./figures/crossValidationForestWithin.png", res = 300, units = "in", height = 5, width = 10, type = "cairo")
