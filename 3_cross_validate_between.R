...
hurdle_est[[my_model]]$label <- "crossBetweenHasCACLHLN"
my_model <- "hurdle_i"
hurdle_est[[my_model]] <- summarize_samples(hurdle_vlls[[my_model]])
hurdle_est[[my_model]]$label <- "crossBetweenHasCACHurdleI"
my_model <- "hurdle"
hurdle_est[[my_model]] <- summarize_samples(hurdle_vlls[[my_model]])
hurdle_est[[my_model]]$label <- "crossBetweenHasCACHurdle"
...
lognormal_est[[my_model]]$label <- "crossBetweenLogCACLHLN"
my_model <- "lognormal_i"
lognormal_est[[my_model]] <- summarize_samples(lognormal_vlls[[my_model]])
lognormal_est[[my_model]]$label <- "crossBetweenLogCACLognormalI"
my_model <- "lognormal"
lognormal_est[[my_model]] <- summarize_samples(lognormal_vlls[[my_model]])
lognormal_est[[my_model]]$label <- "crossBetweenLogCACLognormal"
